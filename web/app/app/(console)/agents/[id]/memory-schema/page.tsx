...
export default function AgentMemorySchemaPage() {
  return (
    <Panel title="Default compact schema">
      <p className="text-sm text-text-muted">Read-only in MVP. Projection is bounded and server-owned — never the full transcript.</p>
